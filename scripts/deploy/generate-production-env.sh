...
AGENTFORGE_AGENT_CONTEXT_TOKEN_BUDGET=8192
AGENTFORGE_AGENT_CONTEXT_RECENT_TURNS=4
AGENTFORGE_AGENT_CONTEXT_SUMMARY_TOKEN_BUDGET=800
AGENTFORGE_AGENT_CONTEXT_MAX_SESSIONS=1000
AGENTFORGE_AGENT_NAMESPACE_TENANT=agentforge
AGENTFORGE_AGENT_NAMESPACE_WORKSPACE=default
