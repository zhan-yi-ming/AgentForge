...
export default function WikiPage({ pages, selectedId, title, content, feedback, busy, createOpen,
  previewOpen, previewPosition, previewSize, onSelect, onOpenGraph, onTitleChange, onContentChange, onSave,
